...
parser.add_argument("--rval", type=int, default=12, help="r value")
parser.add_argument("--alphaval", type=int, default=5, help="alpha value")
parser.add_argument("--low", type=bool, default=False, help="low resource")
...
if args.alphaval == 0:
    ...
    model.visual_encoder.alpha=args.alphaval
model.visual_encoder.r= args.rval
