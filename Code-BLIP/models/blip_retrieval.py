...
class BLIP_Retrieval(nn.Module):
    def __init__(self,                 
        ...
        self.visual_encoder, vision_width = create_vit_retrieval(vit,image_size, vit_grad_ckpt, vit_ckpt_layer)
        ...
        self.visual_encoder_m, vision_width = create_vit_retrieval(vit,image_size)              
